...
const Navbar = () => {
  ...
  return (
    <nav className='max-w-[1440px] mx-auto sticky top-5 z-10'>
      <div className='flex items-center justify-between rounded-full bg-white/50 border border-[#FDCF91] backdrop-blur-[10px] m-5 lg:mx-12 p-3 md:p-0'>
        {/* Portfolio app name */}
        ...
        <Link
          ...
          spy
          offset={-100}
          className='hidden md:flex md:items-center md:justify-center h-12 text-[15px] text-white font-medium bg-gradient-primary rounded-full px-9 transition-transform duration-300 ease-in-out hover:scale-105 cursor-pointer'>
          Hire Me
        </Link>
      </div>
    </nav>
